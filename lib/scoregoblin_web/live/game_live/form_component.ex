defmodule ScoregoblinWeb.GameLive.FormComponent do
  use ScoregoblinWeb, :live_component
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.simple_form
        ...
        phx-submit="save"
      >
        <.input field={@form[:winner_score]} type="number" label="Winner score" />
        <.input field={@form[:loser_score]} type="number" label="Loser score" />
        <:actions>
